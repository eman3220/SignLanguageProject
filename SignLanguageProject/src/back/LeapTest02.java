...
//			System.out.println("Hand: "+hand);
			...
			System.out.println("This is the sphere diameter value:"+sphere_diameter);
//			FingerList finger_list = null;
			for (Finger finger : hand.fingers()) {


//				System.out.println("Finger: "+finger);
				//To do: The tumb is being detected and the C gesture is detected, now we just need an if statement that combines both of these.
...
//					   System.out.println("finger list>>>>: "+hand.fingers().get(2).type());
					 // System.out.println("Finger Type:"+finger_type);
					  ...
					  System.out.println();
					  // C gesture
					  if(sphere_diameter>80 && sphere_diameter<110 && fingers.contains(Type.TYPE_THUMB)){
						  //if(finger_type==Type.TYPE_THUMB){
							System.out.println("this is the C gesture");
						  //else{System.out.println("Not recognising the thumb");}
					  }
					  else if(fingers.contains(Type.TYPE_INDEX) && fingerCount==1){
						  System.out.println("this is a 1 gesture");
					  }
					  else if(fingers.contains(Type.TYPE_INDEX) && fingers.contains(Type.TYPE_MIDDLE) && fingerCount==2){
						  System.out.println("this is a 2 gesture");
					  }
					  else if(fingers.contains(Type.TYPE_INDEX) && fingers.contains(Type.TYPE_MIDDLE)
					  && fingers.contains(Type.TYPE_RING) && fingerCount==3){
						  System.out.println("this is a 3 gesture");
					  }
					  else if(fingers.contains(Type.TYPE_INDEX) && fingers.contains(Type.TYPE_MIDDLE)
					  && fingers.contains(Type.TYPE_RING) && fingers.contains(Type.TYPE_PINKY) && fingerCount==4){
						  System.out.println("this is a 4 gesture");
					  }
					  else if(fingers.contains(Type.TYPE_INDEX) && fingers.contains(Type.TYPE_MIDDLE)
					  && fingers.contains(Type.TYPE_RING) && fingers.contains(Type.TYPE_PINKY)
					  && fingers.contains(Type.TYPE_THUMB) && fingerCount==5){
